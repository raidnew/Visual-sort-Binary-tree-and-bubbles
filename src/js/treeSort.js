function TreeSort(view) {
   ...
   /**
    * select bransh for add value
    * @param value
    * @param tree
    * @returns {
    *    object = branch for next test
    *    true - branch found - value wrote
    * }
    */
   ...
   /**
    * select value form tree
    * @returns {
    *    object - next branch for test
    *    number - branch found, return value
    *    false - sort finish, all branches selected
    * }
    */
